...
if __name__ == '__main__':
    ...
    for file in data_files[24:]:
        ...
        print(scene40.shape)
        print(scene70.shape)
        with open(os.path.join(npzdata_path, file+'_scene40_1st.npz'), 'wb') as f:
            np.savez(f, scene40)
        with open(os.path.join(npzdata_path, file+'_scene70_1st.npz'), 'wb') as f:
            np.savez(f, scene70)
        ...
        with open(os.path.join(npzdata_path, file+'_Q1234_1st_40MHz.npz'), 'wb') as f:
        ...
        with open(os.path.join(npzdata_path, file+'_Q1234_1st_70MHz.npz'), 'wb') as f:
            np.savez(f, np.array([Q1_70MHz,Q2_70MHz,Q3_70MHz,Q4_70MHz]))
        ...
        with open(os.path.join(npzdata_path, file+'_depth_1st_40MHz.npz'), 'wb') as f:
        ...
        with open(os.path.join(npzdata_path, file+'_depth_1st_70MHz.npz'), 'wb') as f:
        ...
        plt.savefig(os.path.join(npzdata_path, dataname + '-' + file + '-' + '-40MHz-3b.png'))
        plt.close()
        ...
        plt.savefig(os.path.join(npzdata_path, dataname + '-' + file + '-' + '-70MHz-3b.png'))
        plt.close()
        ...
        plt.savefig(os.path.join(npzdata_path,dataname+'-'+file+'-'+'-z_corr-3b.png'))
        plt.close()
        ...
        plt.savefig(os.path.join(npzdata_path,dataname+'-'+file+'-'+'-depth-3b.png'))
        plt.close()
        ...
        plt.savefig(os.path.join(npzdata_path,dataname+'-'+file+'-'+'-diff-3b.png'))
        plt.close()
        ...
        # plt.show()
        # plt.savefig(os.path.join('/home/saijo/labwork/研究結果まとめ/AMCW-corner',dataname+'-'+file+'-'+'-diff.png'))
        plt.savefig(os.path.join(npzdata_path,dataname+'-'+file+'-'+'-40MHz-depth.png'))
        plt.close()
        ...
        # plt.show()
        # plt.savefig(os.path.join('/home/saijo/labwork/研究結果まとめ/AMCW-corner',dataname+'-'+file+'-'+'-diff.png'))
        plt.savefig(os.path.join(npzdata_path,dataname+'-'+file+'-'+'-70MHz-depth.png'))
        plt.close()
        ...
        fig.savefig(os.path.join(npzdata_path,dataname+'-'+file+'-'+ '_phase.png'))
        # plt.show()
        plt.close()
