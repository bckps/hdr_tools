...
# folder_path = r'/home/saijo/labwork/PythonSandbox/hdr_process/hdrs/bathroom-smal2'
folder_path = r'hdrs/bathroom-small-simu-20images/00000/hdrs'
...
print(b1_list)
# response_img = np.zeros((258,257,1024,3))
response_img = np.zeros((256,256,2220,3))
# response_img = np.zeros((128,115,512,3))#bunny
# response_img = np.zeros((128,127,1024,3))
...
plt.plot(response_img[94,32,:,0], label="test")
# プロット表示(設定の反映)
plt.show()
