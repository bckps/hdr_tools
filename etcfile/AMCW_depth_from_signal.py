...
if __name__ == '__main__':
    ...
    npz_folder_path = os.path.join(r'/home/saijo/labwork/PythonSandbox/hdr_process/AMCW_npz', dataname)
    ...
    for file in data_files:
        ...
        npzdata_path = os.path.join(r'/home/saijo/labwork/PythonSandbox/hdr_process/AMCW_npz', dataname, file)
        plot_folder_path = os.path.join(r'/home/saijo/labwork/PythonSandbox/hdr_process/AMCW_npz/plots', dataname)
        ...
        for f in os.listdir(npzdata_path):
            load_file = os.path.join(npzdata_path, f)
            if 'A0' in f:
                ...
                with np.load(load_file) as data: A2_img = data.get('arr_0')
            elif 'scene40' in f:
                with np.load(load_file) as data:
                    scene40 = data.get('arr_0')
            elif 'scene70' in f:
                with np.load(load_file) as data:
                    scene70 = data.get('arr_0')
            elif 'truth' in f:
                with np.load(load_file) as data:
                    depth_2220_nz = data.get('arr_0')
            # elif 'phase' in f:
            #     with np.load(load_file) as data:
            #         scene70 = data.get('arr_0')
        ...
        with open(os.path.join(npzdata_path, file+'_Q1234_40MHz.npz'), 'wb') as f:
            np.savez(f, np.array([Q1_40MHz,Q2_40MHz,Q3_40MHz,Q4_40MHz]))
        ...
        scene40_img = scene40[30, 30, :]
        scene70_img = scene70[30,30,:]
        z_corr_get = z_corr_depth
        depth_2220_get = depth_2220_nz
        ...
        plt.savefig(os.path.join(plot_folder_path, dataname + '-' + file + '-' + '-40MHz-3b.png'))
        plt.close()
        ...
        plt.savefig(os.path.join(plot_folder_path, dataname + '-' + file + '-' + '-70MHz-3b.png'))
        plt.close()
        ...
        plt.savefig(os.path.join(plot_folder_path,dataname+'-'+file+'-'+'-z_corr-3b.png'))
        plt.close()
        ...
        plt.savefig(os.path.join(plot_folder_path,dataname+'-'+file+'-'+'-depth-3b.png'))
        plt.close()
        ...
        plt.savefig(os.path.join(plot_folder_path,dataname+'-'+file+'-'+'-diff-3b.png'))
        plt.close()
        ...
        print('depth_40MHz',np.min(depth_40MHz),np.mean(depth_40MHz),np.max(depth_40MHz))
        plt.figure()
        plt.imshow(depth_40MHz, label="test")
        plt.colorbar(format="%.3f")
        # plt.show()
        # plt.savefig(os.path.join('/home/saijo/labwork/研究結果まとめ/AMCW-corner',dataname+'-'+file+'-'+'-diff.png'))
        plt.savefig(os.path.join(plot_folder_path,dataname+'-'+file+'-'+'-40MHz-depth.png'))
        plt.close()

        plt.figure()
        plt.imshow(depth_40MHz-depth_2220_get, label="test")
        plt.colorbar(format="%.3f")
        # plt.show()
        # plt.savefig(os.path.join('/home/saijo/labwork/研究結果まとめ/AMCW-corner',dataname+'-'+file+'-'+'-diff.png'))
        plt.savefig(os.path.join(plot_folder_path,dataname+'-'+file+'-'+'-40MHz-depth-diff.png'))
        plt.close()

        print('depth_70MHz', np.min(depth_70MHz), np.mean(depth_70MHz), np.max(depth_70MHz))
        plt.figure()
        plt.imshow(depth_70MHz, label="test")
        plt.colorbar(format="%.3f")
        # plt.show()
        # plt.savefig(os.path.join('/home/saijo/labwork/研究結果まとめ/AMCW-corner',dataname+'-'+file+'-'+'-diff.png'))
        plt.savefig(os.path.join(plot_folder_path,dataname+'-'+file+'-'+'-70MHz-depth.png'))
        plt.close()

        plt.figure()
        plt.imshow(depth_70MHz-depth_2220_get, label="test")
        plt.colorbar(format="%.3f")
        # plt.show()
        # plt.savefig(os.path.join('/home/saijo/labwork/研究結果まとめ/AMCW-corner',dataname+'-'+file+'-'+'-diff.png'))
        plt.savefig(os.path.join(plot_folder_path,dataname+'-'+file+'-'+'-70MHz-depth-diff.png'))
        plt.close()
        ...
        fig.savefig(os.path.join(plot_folder_path,dataname+'-'+file+'-'+ '_phase.png'))
        # plt.show()
        plt.close()
