...
class ToFDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        data_path = os.path.join(r'/home/saijo/labwork/local-香川研/pytorchDeepToF/numpy_sensor_data',
...
def show_gen_image(cap_image, cap_ideal_image, depth_image, gen_image,z_corr, iters):
    ...
    fig.savefig(os.path.join(r'/home/saijo/labwork/local-香川研/pytorchDeepToF/numpy_sensor_data',image_prefix+'delay_row32th_{}.png'.format(iters)))
    plt.show()
    ...
    axs[1,1].set_xlabel('Column number',fontsize=14)
    axs[1,1].set_ylabel('Depth [m]',fontsize=14)
    fig.savefig(os.path.join(r'/home/saijo/labwork/local-香川研/pytorchDeepToF/numpy_sensor_data',image_prefix+'_row64th_{}.png'.format(iters)))
    plt.show()
    ...
    axs[1,1].set_xlabel('Column number',fontsize=14)
    axs[1,1].set_ylabel('Depth [m]',fontsize=14)
    fig.savefig(os.path.join(r'/home/saijo/labwork/local-香川研/pytorchDeepToF/numpy_sensor_data',image_prefix+'_row96th_{}.png'.format(iters)))
    plt.show()
...
if __name__ == '__main__':
    ...
    generator = Generator()
    generator.load_state_dict(torch.load(r'/home/saijo/labwork/local-香川研/pytorchDeepToF/results/sample_cat_delay1/gen_3999times_model.pt')['model_state_dict'])
    generator.eval()
